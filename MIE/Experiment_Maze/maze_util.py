...
move_directions = {
         ...
         #'move_north': (-1, 0),       # Same as move_up
         #'move_south': (1, 0),      # Same as move_down
         #'move_east': (0, 1),        # Same as move_right
         #'move_west': (0, -1),       # Same as move_left
       #'move_north_east': (-1, 1),  # Moving northeast increases both x and y coordinates
        #'move_south_east': (1, 1), # Moving southeast increases x and decreases y
       #'move_north_west': (-1, -1), # Moving northwest decreases x and increases y
       #'move_south_west': (1, -1) # Moving southwest decreases both x and y coordinates
    }
...
def pathfinding(start, end, grid, basic_moves, recursive_rules):
    ...
    return None, total_steps  # No path found
